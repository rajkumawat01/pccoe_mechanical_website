...
<head>
    ...
    <title>Coordinator Desk | M.tech Heat Power Engineering | PG | Department of Mechanical Engineering at PCCOE</title>
    <style></style>
</head>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="container mt-4 rounded p-2 hod-desk bg-light">
                    <div class="container-fluid title">Co-oridinator Desk</div>
                    <div class="row mt-5">
                        <div class="col-xl-4">
                            <div class="text-center">
                                <img src="../faculty photo/ARoy.jpg" height="280px" width="250px"
                                    class="rounded pb-2" />
                                <p class="">
                                    <b> Dr. Anindita Roy </b><br>
                                    <small>(M.E. Heat Power Coordinator, Department
                                        of Mechanical Engineering, PCCOE)</small><br>
                                </p>
                            </div>
                            <div class="container label-area">
                                <table class="table table-borderless">
                                    <tr>
                                        ...
                                        <td> <small>Ph.D.</small></td>
                                    </tr>
                                    <tr>
                                        <td><span>Experience :</span></td>
                                        <td><small>8+ Years</small></td>
                                    </tr>
                                    <tr>
                                        <td><span>Research Domain :</span></td>
                                        <td><small> Renewable Energy</small></td>
                                    </tr>
                                    <tr>
                                        <td><span>Email :</span></td>
                                        <td><small>anindita.roy@pccoepune.org</small></td>
                                    </tr>
                                    <tr>
                                        <td><span>Contact :</span></td>
                                        <td><small>9970178175</small></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        <div class="col-xl-8">
                            <p class="text-data">
                                The tangible growth in science, engineering and technology is evident in advancement in
                                civilization. Accelerating change is witness in technological breakthroughs and new
                                discoveries. Wherein, this advancement has also given us unlimited opportunities to
                                contribute to a greater cause of humanity and nature, on a global platform. Engineering
                                sector have been a one of the driving factor and major contributors to the research
                                strength and economic stability of the India. As highlighted by our Prime Minister,
                                there are grand challenges in energy sector, water, environment, food, health, housing
                                and safety. Mechanical engineers should and must take the leadership role to bring the
                                engineer's perspective to above social issues. In order to meet these challenges, we
                                have to find sustainable engineering solutions that demands synchronization of regional
                                engineering development and global partnership. Our students must have knowledge that
                                spans across multiple disciplines and should be very well acquainted with latest
                                technology developments that meets the basic needs of society and future requirements.
                            </p>
                            <p class="text-data">
                                We are obliged to provide state of the art teaching-learning environment that strives
                                our student to get an education beyond engineering. It requires fine integration of
                                teaching-learning techniques with research and innovation. There is a greater need to
                                educate students in fundamentals of ethics, social awareness / commitment, human values.
                                To encourage this diversity, we, at PCCoE, have designed the teaching learning process,
                                in line with SPPU guidelines, to ensure the holistic growth of our students. Our
                                teaching-learning strategies are always aimed for engaging students more effectively in
                                learning fundamental technical knowledge that leads to innovative thinking, problem
                                solving capability and enhanced skills.
                            </p>
                        </div>
                    </div>
                </div>
