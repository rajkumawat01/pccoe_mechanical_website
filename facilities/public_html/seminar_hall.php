<html>
    <head>
		...
		<title>Library | Facilities | Department Of Mechanical Engineering at PCCOE</title>
		<!-- Icon -->
        ...
        <div class="bg-light p-3">
		  ...
		  <div class="container">
                <div class="row justify-content-evenly">
                    <div class="col-5">
					<div class="card" > 
					<img class="card-img-top" src="imageslab/seminar1 (1).jpg" alt="Card image cap"  class="shadow p-3 mb-5 bg-white rounded" width="500" height="300">
					</div>
					</div>
				
					<div class="col-5">
					<div class="card" > 
					<img class="card-img-top" src="imageslab/seminar1 (2).jpg" alt="Card image cap"  class="shadow p-3 mb-5 bg-white rounded" width="500" height="300">
					</div>
					</div>
			</div>
			</div>
...
<div class="mySlides fade">
  ...
  <img src="imageslab/seminar1 (4).jpg" style="width:100%" height="430px">
  <!--<div class="text">Caption Text</div>-->
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 5</div>
  <img src="imageslab/seminar1 (1).jpg" style="width:100%" height="430px">
  
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 5</div>
  <img src="imageslab/seminar1 (3).jpg" style="width:100%" height="430px">
  
</div>

<div class="mySlides fade">
  <div class="numbertext">4 / 5</div>
  <img src="imageslab/seminar1 (2).jpg" style="width:100%" height="430px">
  <!--<div class="text">Caption Text</div>-->
</div>

<div class="mySlides fade">
  <div class="numbertext">5 / 5</div>
  <img src="imageslab/seminar1 (5).jpg" style="width:100%" height="430px">
