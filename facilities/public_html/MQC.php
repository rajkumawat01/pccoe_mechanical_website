<html>
    <head>
		...
		<title>Metrology & Quality Control Lab| Facilities | Department Of Mechanical Engineering at PCCOE</title>
  ...
  <div class="container-fluid header">
	...
	<br>
	   <div class="border-5 border-start border-primary shadow mb-4 ps-3 py-2 align-self-center text-dark">
	    <h2>Metrology & Quality Control Lab</h2>
       </div>
...
<div class="mySlides fade">
  ...
  <img src="imageslab/mqc (2).jpg" style="width:100%" height="400px">
  <!--<div class="text">Caption Text</div>-->
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 7</div>
  <img src="imageslab/mqc (3).jpg" style="width:100%" height="400px">
  
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 7</div>
  <img src="imageslab/mqc (1).jpg" style="width:100%" height="400px">
  
</div>

<div class="mySlides fade">
  <div class="numbertext">4 / 7</div>
  <img src="imageslab/mqc (4).jpg" style="width:100%" height="400px">
  <!--<div class="text">Caption Text</div>-->
</div>

<div class="mySlides fade">
  <div class="numbertext">5 / 7</div>
  <img src="imageslab/mqc (5).jpg" style="width:100%" height="400px">
  
</div>
<div class="mySlides fade">
  <div class="numbertext">6 / 7</div>
  <img src="imageslab/mqc (6).7pg" style="width:100%" height="400px">
  
</div>
<div class="mySlides fade">
  <div class="numbertext">7 / 7</div>
  <img src="imageslab/mqc (7).jpg" style="width:100%" height="400px">
