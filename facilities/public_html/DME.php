...
@media only screen and (max-width: 300px) {
 ...
 <header>
  <div class="container-fluid header">
	...
	<h2>Design of Machine Elements</h2>
     </div>
...
<div class="mySlides fade">
  ...
  <img src="imageslab/DOM (4).jpg" style="width:100%" height="400px">
  <!--<div class="text">Caption Text</div>-->
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 4</div>
  <img src="imageslab/DOM (3).jpg" style="width:100%" height="400px">
  
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 4</div>
  <img src="imageslab/DOM (5).jpg" style="width:100%" height="400px">
  
</div>

<div class="mySlides fade">
  <div class="numbertext">4 / 4</div>
  <img src="imageslab/DOM (6).jpg" style="width:100%" height="400px">
  <!--<div class="text">Caption Text</div>-->
</div>
</div>
<br>
