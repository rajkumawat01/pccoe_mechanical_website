<html>
    <head>
		...
		<title>Material Science & Meatallurgy lab| Facilities | Department Of Mechanical Engineering at PCCOE</title>
...
@media only screen and (max-width: 300px) {
 ...
 <header>
  <div class="container-fluid header">
	...
	<h2>Material Science & Metallurgy lab</h2>
     </div>
...
<div class="mySlides fade">
  ...
  <img src="imageslab/MML (2).jpg" style="width:100%" height="430px">
  <!--<div class="text">Caption Text</div>-->
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 6</div>
  <img src="imageslab/MML (4).jpg" style="width:100%" height="430px">
  
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 6</div>
  <img src="imageslab/MML (1).jpg" style="width:100%" height="430px">
  
</div>

<div class="mySlides fade">
  <div class="numbertext">4 / 6</div>
  <img src="imageslab/MML (5).jpg" style="width:100%" height="430px">
  <!--<div class="text">Caption Text</div>-->
</div>

<div class="mySlides fade">
  <div class="numbertext">5 / 6</div>
  <img src="imageslab/MML (6).jpg" style="width:100%" height="430px">
  
</div>
<div class="mySlides fade">
  <div class="numbertext">6 / 6</div>
  <img src="imageslab/MML (7).jpg" style="width:100%" height="430px">
