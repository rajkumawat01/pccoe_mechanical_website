...
<head>
    ...
    <title>Time Table | Student Corner | Department of Mechanical Engineering at PCCOE</title>
    <style></style>
</head>
...
<br><br>
    ...
    <div class="container p-2 mt-3 time-table bg-light">
    <div class="pt-4">
        <ul class="fa-ul">
            <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank" href="../vender/files/time_table/SE Class TT  Sem 1 A.Y. 2021-22(for website).pdf">SY - B. Tech (Mechanical Engineering)</a></li>
            <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank" href="../vender/files/time_table/TE Class TT  Sem 1 A.Y. 2021-22.pdf">T.E - Bachlor of Engineering (Mechanical Engineering)</a></li>
            <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank" href="../vender/files/time_table/BE Class TT Sem 1 A.Y. 2021-22.pdf">B.E - Bachlor of Engineering (Mechanical Engineering)</a></li>
        </ul>
    </div>
</div>
