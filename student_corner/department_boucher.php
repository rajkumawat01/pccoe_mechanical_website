...
<head>
    ...
    <title>Student Corner | Department Boucher | Student Corner | Department of Mechanical Engineering at PCCOE</title>
    <style></style>
</head>
        ...
        <div class="pt-4">
            <ul class="fa-ul">
                <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> 
                  <a target="_blank" href="../vender/files/department_boucher/samvaad, Volume 1, Issue 1.pdf">
                    Samvaad Volume 1 Issue 1
                  </a>
              </li>
                <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> 
                    <a target="_blank" href="../vender/files/department_boucher/Samvaad_Volume 1 Issue 2_Final.pdf">
                        Samvaad Volume 1 Issue 2
                    </a>
                </li>
                <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> 
                    <a target="_blank" href="../vender/files/department_boucher/1623508314920_samvaad Vol 1, Issue 3.pdf">
                        Samvaad Volume 1 Issue 3
                    </a>
                </li>
                <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> 
                    <a target="_blank" href="../vender/files/department_boucher/Samvaad, Volume 1, Issue 4 , 15 July 2021.pdf">
                        Samvaad Volume 1 Issue 4
                    </a>
                </li>
                <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> 
                    <a target="_blank" href="../vender/files/department_boucher/Samvaad, Volume 1, Issue 5 , 15 August 2021.pdf">
                        Samvaad Volume 1 Issue 5
                    </a>
                </li>
                <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> 
                    <a target="_blank" href="../vender/files/department_boucher/Samvaad, Volume 1, Issue 6 , 14 September 2021.pdf">
                        Samvaad Volume 1 Issue 6
                    </a>
                </li>
                <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> 
                  <a target="_blank" href="../vender/files/department_boucher/Samvaad, Volume 1, Issue 7 , 15 October 2021_R2.pdf">
