...
<head>
    ...
    <title>Syllabus | Student Corner | Department of Mechanical Engineering at PCCOE</title>
    <style></style>
</head>
...
<br><br>
    ...
    <div class="pt-2">
        <ul class="fa-ul">
            ...
            <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank" href="../vender/files/syllabus/TE_Mechanical Engineering (2019 Course).pdf">T.E - Bachlor of Engineering (Mechanical Engineering)</a></li>
            <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank" href="../vender/files/syllabus/Final year mech.pdf">B.E - Bachlor of Engineering (Mechanical Engineering)</a></li>
        </ul>
    </div>
</div>
